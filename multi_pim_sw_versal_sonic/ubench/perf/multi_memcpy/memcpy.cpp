...
int main(int argc, char *argv[])
{
    ...
    short* PL_srcA_buf0 = (short*)mmap(0, srcA_size*sizeof(short), PROT_READ | PROT_WRITE, MAP_PRIVATE | MAP_ANONYMOUS, -1, 0);
    short* PL_dstC_buf0 = (short*)mmap(0, srcA_size*sizeof(short), PROT_READ | PROT_WRITE, MAP_SHARED, fd, 0xc4000000);
    short* PL_srcA_buf1 = (short*)mmap(0, srcA_size*sizeof(short), PROT_READ | PROT_WRITE, MAP_PRIVATE | MAP_ANONYMOUS, -1, 0);
    short* PL_dstC_buf1 = (short*)mmap(0, srcA_size*sizeof(short), PROT_READ | PROT_WRITE, MAP_PRIVATE | MAP_ANONYMOUS, -1, 0);
    // short* PL_srcA_buf0 = (short*)mmap(0, srcA_size*sizeof(short), PROT_READ | PROT_WRITE, MAP_SHARED, fd, 0xc4000000);
    // short* PL_dstC_buf0 = (short*)mmap(0, srcA_size*sizeof(short), PROT_READ | PROT_WRITE, MAP_SHARED, fd, 0xc4002000);
    // short* PL_srcA_buf1 = (short*)mmap(0, srcA_size*sizeof(short), PROT_READ | PROT_WRITE, MAP_SHARED, fd, 0xc4004000);
    // short* PL_dstC_buf1 = (short*)mmap(0, srcA_size*sizeof(short), PROT_READ | PROT_WRITE, MAP_SHARED, fd, 0xc4006000);
