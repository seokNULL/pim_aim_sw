 ...
 *  all of the bars
 */
#define XDMA_CONFIG_BAR_NUM	0	// set BAR0 to XDMA configuration

/* SECTION: Preprocessor macros/constants */
#define XDMA_BAR_NUM (1)
// #define XDMA_BAR_NUM (6)	// modified
...
// #define XDMA_CHANNEL_NUM_MAX (1)	// Set MAX channel to 1 
#define XDMA_CHANNEL_NUM_MAX (4)	// Set MAX channel to 4 (if set 1, pim2cpu error)
/*
...
struct xdma_io_cb {
	...
	u32 write:1; // modified to integer type size
